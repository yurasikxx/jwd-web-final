...
public enum BaseApplicationCommand {
    ...
    PERSON_CHANGING_PAGE(ShowPersonChangingPageCommand.getInstance(), ADMINISTRATOR),
    PERSON_CHANGE(PersonChangingCommand.getInstance(), ADMINISTRATOR),
    ...
    BETSLIP_CHANGING_PAGE(ShowBetslipChangingPageCommand.getInstance(), ADMINISTRATOR),
    BETSLIP_CHANGE(BetslipChangingCommand.getInstance(), ADMINISTRATOR),
